...
var metricMaps = map[string]map[string]ColumnMapping{
	...
	"pg_stat_all_tables": map[string]ColumnMapping{
		"relid":               {LABEL, "OID of a table", nil},
		"schemaname":          {LABEL, "Name of the schema that this table is in", nil},
		"relname":             {LABEL, "Name of this table", nil},
		"seq_scan":            {COUNTER, "Number of sequential scans initiated on this table", nil},
		"seq_tup_read":        {COUNTER, "Number of live rows fetched by sequential scans", nil},
		"idx_scan":            {COUNTER, "Number of index scans initiated on this table", nil},
		"idx_tup_fetch":       {COUNTER, "Number of live rows fetched by index scans", nil},
		"n_tup_ins":           {COUNTER, "Number of rows inserted", nil},
		"n_tup_upd":           {COUNTER, "Number of rows updated", nil},
		"n_tup_del":           {COUNTER, "Number of rows deleted", nil},
		"n_tup_hot_upd":       {COUNTER, "Number of rows HOT updated (i.e., with no separate index update required)", nil},
		"n_live_tup":          {GAUGE, "Estimated number of live rows", nil},
		"n_dead_tup":          {GAUGE, "Estimated number of dead rows", nil},
		"n_mod_since_analyze": {GAUGE, "Estimated number of rows modified since this table was last analyzed", nil},
		"last_vacuum":         {COUNTER, "Last time at which this table was manually vacuumed (not counting VACUUM FULL)", nil},
		"last_autovacuum":     {COUNTER, "Last time at which this table was vacuumed by the autovacuum daemon", nil},
		"last_analyze":        {COUNTER, "Last time at which this table was manually analyzed", nil},
		"last_autoanalyze":    {COUNTER, "Last time at which this table was analyzed by the autovacuum daemon", nil},
		"vacuum_count":        {COUNTER, "Number of times this table has been manually vacuumed (not counting VACUUM FULL)", nil},
		"autovacuum_count":    {COUNTER, "Number of times this table has been vacuumed by the autovacuum daemon", nil},
		"analyze_count":       {COUNTER, "Number of times this table has been manually analyzed", nil},
		"autoanalyze_count":   {COUNTER, "Number of times this table has been analyzed by the autovacuum daemon", nil},
	},
